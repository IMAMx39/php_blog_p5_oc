        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center" ">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <img class="text-center" src="assets/img/img2.jpg" style=" border-radius: 50%;  width: 20rem;height: 20rem; margin-left: 10rem; " alt="">
                    <hr class="my-4"/>
                </div>
            </div>
        </div>
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <p>
                    Bienvenu !
                    Eius praesentium recusandae illo eaque architecto error, repellendus iusto reprehenderit, doloribus,
                    minus sunt.
                ...
                <h3 class="text-center" style="text-decoration: underline;">
                    <a class="btn btn-primary" role="button" href="assets/downloads/CV.pdf" download="IMAMOSx95.pdf">Téléchargez
                        mon CV !</a>
                </h3>
